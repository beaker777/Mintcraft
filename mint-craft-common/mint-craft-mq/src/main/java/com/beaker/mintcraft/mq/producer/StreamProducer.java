package com.beaker.mintcraft.mq.producer;
...
public class StreamProducer {
    ...
    public boolean send(String bingingName, String tag, String msg) {
        ...
        boolean result = streamBridge
                .send(bingingName, MessageBuilder.withPayload(message).setHeader("TAGS", tag)
                .build());
    ...
    public boolean send(String bingingName, String tag, String msg, int delayLevel) {
        ...
        boolean result = streamBridge
                .send(
                        bingingName, MessageBuilder.withPayload(message)
                                .setHeader("TAGS", tag)
